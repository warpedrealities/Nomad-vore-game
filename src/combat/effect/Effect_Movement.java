...
public class Effect_Movement extends Effect {
	...
	enum MovementType{self_away,self_towards, target_towards, target_away};
	...
	{
		int localDistance=origin.getRPG().getAbility(abilityMod)-origin.getRPG().getAbilityMod(abilityMod)+distance;
