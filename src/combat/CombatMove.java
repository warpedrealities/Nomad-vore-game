...
public class CombatMove {
	...
	{
		//check los
		if (GameManager.m_los.existsLineOfSight(Universe.getInstance().getCurrentZone(), 
				(int)origin.getPosition().x, (int)origin.getPosition().y, 
				(int)target.getPosition().x, (int)target.getPosition().y, false))
		{
			//check range
