...
public class ItemContainerScreen extends Screen implements Callback {
	...
	private ItemContainerInstance container;
	private Window window;
	private List[] itemLists;
	private Text[] weightValues;
	private Callback callback;
	private int [] sceneResources;

	public ItemContainerScreen(ItemContainerInstance container) {
		this.container = container;
		this.player = Universe.getInstance().getPlayer();
		this.player.getInventory().setWeight(this.player.getInventory().getWeight()-this.container.getAdjustedContentWeight());
	}
