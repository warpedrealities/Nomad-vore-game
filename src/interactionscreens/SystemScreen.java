...
public class SystemScreen extends Screen implements Callback {
	...
	private boolean trythis(Item item)
	{
		...
		if (resourceObj.getContainsWhat().equals("ENERGY") && ItemDepletableInstance.class.isInstance(item))
		{
			...
			if (ie!=null && ie.getRefill()!=null && ie.getRefill().contains("ENERGY") && energy<ie.getMaxEnergy())
			{
				...
				//if resource energy equal or greater, fully recharge and subtract
	...
	private void resetList()
	{
		...
		if (resourceObj!=null)
		{
			...
			resource.setString(resourceObj.getContainsWhat()+" "+resourceObj.getAmountContained()+"/"+resourceObj.getContainedCapacity());
