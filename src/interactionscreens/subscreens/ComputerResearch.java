	...
	private void research(String research)
	{
		...
		if (r!=null)
		{
			...
			if (finalroll>=r.getDC())
			{
				...
				{
					popup.setText("you have successfully researched "+research+" and have compiled a new entry on your findings");
				}
				else
				{
			...
			{
				popup.setClock(10);
				popup.setText("you have failed to reach meaningful conclusions on the topic of "+research+ "you need more data");
			}
