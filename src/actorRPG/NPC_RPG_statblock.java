...
//		attackPool=new Attack[Integer.parseInt(rpgnode.getAttribute("numattacks"))];
		...
		for (int i=0;i<children.getLength();i++)
		{
			...
			if (N.getNodeType()==Node.ELEMENT_NODE)
			{
				...
				{
					abilities[RPG_Helper.abilityFromString(Enode.getAttribute("ability"))]=Integer.parseInt(Enode.getAttribute("value"));
				}
				if (Enode.getTagName()=="attribute")
				{
					attributes[RPG_Helper.AttributefromString(Enode.getAttribute("attribute"))]=Integer.parseInt(Enode.getAttribute("value"));
				}
				...
				{
					statMaximum[RPG_Helper.statFromString(Enode.getAttribute("stat"))]=Integer.parseInt(Enode.getAttribute("value"));
				}
